 ...
 */
@WebServlet("/FreeNovelList.do")
public class FreeNovelListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FreeNovelListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int listCount = ns.getListCount(free,complate);
		...
		list = ns.selectNovelList(currentPage, limit , free, complate);
		top3list = ns.selectTop3List(free, complate);
		String page = "";
		page = "/WEB-INF/views/novelPage/FreeNovelList.jsp";
