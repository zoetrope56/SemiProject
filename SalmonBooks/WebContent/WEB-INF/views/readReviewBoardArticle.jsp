...
<body>
    <div class="titlebar">
        ...
        <div class="titleMenu">
            <div class="titleMenuIcon"><a href="/SalmonBooks/" style="border-bottom: 5px solid bisque; text-decoration: none; color:white;">홈</a></div>
            ...
            <div class="titleMenuIcon"><a href="list.do" style="text-decoration: none; color:white;">커뮤니티</a></div>
